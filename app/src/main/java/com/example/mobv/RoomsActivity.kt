...
class RoomsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSend.setOnClickListener {
            ...
            if (msg != "") {
                ...
                Toast.makeText(this@RoomsActivity, "Prázdna správa", Toast.LENGTH_SHORT).show()
            }
    ...
    private fun sendMessage(sender: String, receiver: String, message: String) {
        messagingRepository.messageContact(this@RoomsActivity, sender, receiver, message, {
            messages.add(Chat(sender, receiver, message))

        }, {
            it.printStackTrace()
            Toast.makeText(this@RoomsActivity, "Odosielanie zlyhalo", Toast.LENGTH_SHORT).show()
        })
    }

    private fun readMessages(uid: String, receiver: String) {
        messagingRepository.readContact(this@RoomsActivity, uid, getContactId(), { contactMessages ->
            ...
            messageAdapter = MessageAdapter(this@RoomsActivity, messages)
